...
static void TestCreate()
{
	...
	sortedlist_t *list = SortedListCreate(SortBySize);
...
static void TestFind()
{
	...
	found_iter = SortedListFind(list, SortedListBegin(list), SortedListEnd(list), (void*)&to_find);
...
static void TestMerge()
{
	...
	sortedlist_t *dest_list = SortedListCreate(SortBySize);
	sortedlist_t *src_list = SortedListCreate(SortBySize);
